...
train_tokenized = train_dataset.map(tokenize_and_align_labels, batched=True, remove_columns=["tokens", "ner_tags", "labels"])
eval_tokenized = eval_dataset.map(tokenize_and_align_labels, batched=True, remove_columns=["tokens", "ner_tags", "labels"])
...
model.save_pretrained("./mbert_amharic_ner")
tokenizer.save_pretrained("./mbert_amharic_ner")